  ...
  return (
    <section id="example-report" className="bg-bg py-20">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        ...
        <article className="rounded-[2rem] border border-border bg-surface p-6 shadow-card sm:p-8">
          <div className="mb-6 flex items-center justify-between gap-4">
            <div className="grid h-12 w-12 place-items-center rounded-2xl bg-primarySoft text-primary">
              <Lightbulb size={24} aria-hidden="true" />
            </div>
            <span className="inline-flex items-center gap-2 rounded-full bg-accentSoft px-4 py-2 text-sm font-bold text-primaryDark">
              <Flag size={16} aria-hidden="true" />
              High priority
            </span>
          </div>

          <h3 className="font-heading text-2xl font-bold text-text">Your CTA is visible, but the offer is not clear enough</h3>
          ...
          <a
            href="#audit"
            className="mt-6 inline-flex items-center gap-2 font-bold text-primary transition hover:text-primaryDark"
          >
            Get your own report
