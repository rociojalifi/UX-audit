    ...
    return (
        <div className="fixed inset-0 z-[60] grid place-items-center bg-primaryDark/35 px-5 py-8 backdrop-blur-sm">
            <section
                ...
                className="relative w-full max-w-2xl overflow-hidden rounded-[2.25rem] border border-border bg-surface p-5 shadow-soft sm:p-7"
            >
                ...
                <div className="relative">
                    ...
                    <div className="grid gap-4 text-left sm:flex sm:items-center">
                        <div className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-primarySoft text-primary ring-4 ring-accentBlueSoft/35 sm:h-12 sm:w-12">
                            <Mail size={22} aria-hidden="true" />
                        </div>

                        <h2
                            id="email-unlock-title"
                            className="font-heading text-3xl font-bold leading-tight text-text sm:text-2xl lg:whitespace-nowrap lg:text-3xl"
                        >
                    ...
                    <p className="mt-3 rounded-2xl border border-primary/10 bg-primarySoft/55 px-3 py-3 text-sm font-semibold leading-6 text-primaryDark">
                        This is not a signup. Just your free mini-audit.
                    </p>
